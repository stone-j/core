...
public class OpenCV {
   ...
   */
//  public OpenCV(String pathToImg, boolean useColor){
//  	initNative();
...
//  }
   ...
   */
//  public OpenCV(PImage img, boolean useColor){
//  	initNative();
//  	this.useColor = useColor;
//  	if(useColor){
//  		useColor();  
...
//  		ConsoleHelper.PrintMessage("ERROR: color space must be either RGB or HSB");
//  	} else {
